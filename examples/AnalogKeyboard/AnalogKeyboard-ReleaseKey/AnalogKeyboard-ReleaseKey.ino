/*
  (Português)
  Exemplo de Utilização do Método release() da Classe ES_AnalogKeyboard

  Objetivo:
  Este exemplo demonstra como utilizar o método release() da classe ES_AnalogKeyboard para verificar se as teclas do teclado
...
/*
  (English)
  Example of Using the release() Method of the ES_AnalogKeyboard Class

  Objective:
  This example demonstrates how to use the release() method of the ES_AnalogKeyboard class to check if the keys of the ES32Lab
