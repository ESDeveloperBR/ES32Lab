...
Library Download: https://github.com/ederjsantini/TFT_eSPI_ES32Lab
...
void setup(void) {
  ...
  tft.setTextColor(TFT_BLUE, TFT_GREY);  // Adding a black background colour erases previous text automatically
  ...
  tft.drawCentreString("ES32Lab", 64, 130, 4);
