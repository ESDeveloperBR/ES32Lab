...
Objective:
- Use the "TimeInterval" class that manages the time through the "milles()" command, not stopping the code in execution;

Objetivo:
- Utilizar a classe "TimeInterval" que gerencia o tempo através do comando "milles()", não parando o código em execução;
*/
