...
/*  Compare two strings */
boolean ES_TFT::_compareStr(String str1, String str2){
    str1.toUpperCase();
    str2.toUpperCase();
...
// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Inicializa a lib ES_TFT >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
/* Initialize the ES_TFT lib */
void ES_TFT::init(uint8_t tc){  
    tft.init(tc);
}
/* Initialize the ES_TFT lib */
void ES_TFT::begin(uint8_t tc){  
    tft.begin(tc);
}
...
-color: Pixel color;
*/
void ES_TFT::drawPixel(int32_t x, int32_t y, uint32_t color){
...
*/
void ES_TFT::drawLine(int32_t x0, int32_t y0, int32_t x1, int32_t y1, uint32_t color){
...
-color: drawLine color;
*/
void ES_TFT::drawFastVLine(int32_t x, int32_t y, int32_t h, uint32_t color){
...
*/
void ES_TFT::drawFastHLine(int32_t x, int32_t y, int32_t w, uint32_t color){
...
*/
void ES_TFT::fillRect(int32_t x, int32_t y, int32_t w, int32_t h, uint32_t color){
...
-color: Rectangle color;
*/
void ES_TFT::drawRect(int32_t x, int32_t y, int32_t w, int32_t h, uint32_t color){
...
-color: Rectangle color;
*/
void ES_TFT::drawRoundRect(int32_t x, int32_t y, int32_t w, int32_t h, int32_t r, uint32_t color){
...
-color: Rectangle color;
*/
void ES_TFT::fillRoundRect(int32_t x, int32_t y, int32_t w, int32_t h, int32_t r, uint32_t color){
...
*/
void ES_TFT::fillRectVGradient(int16_t x, int16_t y, int16_t w, int16_t h, uint32_t color1, uint32_t color2){
...
-color2: Color 2 gradient;
*/
void ES_TFT::fillRectHGradient(int16_t x, int16_t y, int16_t w, int16_t h, uint32_t color1, uint32_t color2){
...
-color: Circle color;
*/
void ES_TFT::drawCircle(int32_t x, int32_t y, int32_t r, uint32_t color){
...
-color: Circle color;
*/
void ES_TFT::drawCircleHelper( int32_t x, int32_t y, int32_t r, uint8_t cornername, uint32_t color){
...
-color: Circle color;
*/
void ES_TFT::fillCircle(int32_t x, int32_t y, int32_t r, uint32_t color){
...
- color: Circle color;
*/
void ES_TFT::fillCircleHelper(int32_t x, int32_t y, int32_t r, uint8_t cornername, int32_t delta, uint32_t color){
...
- color: Ellipse color;
*/
void ES_TFT::drawEllipse(int16_t x, int16_t y, int32_t rx, int32_t ry, uint16_t color){
...
- color: Ellipse color;
*/
void ES_TFT::fillEllipse(int16_t x, int16_t y, int32_t rx, int32_t ry, uint16_t color){
...
*/
void ES_TFT::drawTriangle(int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t x3, int32_t y3, uint32_t color){
...
- color: Triangle color;
*/
void ES_TFT::fillTriangle(int32_t x1, int32_t y1, int32_t x2, int32_t y2, int32_t x3, int32_t y3, uint32_t color){
    tft.fillTriangle(x1, y1, x2, y2, x3, y3, color);
}

/*Return height*/
int16_t ES_TFT::height(void){
    return tft.height();
}

/*Return width*/
int16_t ES_TFT::width(void){
    return tft.width();
}
...
void ES_TFT::setRotation(uint8_t r){  
    tft.setRotation(r);
}

/*Get screen rotation */
uint8_t ES_TFT::getRotation(void){
    return tft.getRotation();
}

// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Cor da tela de fundo >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
/* Fill Screen */
void ES_TFT::fillScreen(uint32_t color){  
...
*/
void ES_TFT::loadFontArray(const uint8_t array[]){
    tft.loadFont(array);
}
...
void ES_TFT::unloadFont(void){
    tft.unloadFont();
}
/* <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Coordenada do cursor no display >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> */
// Coordenada do cursor no display
void ES_TFT::setCursor(int16_t x, int16_t y){  
    tft.setCursor(x, y);
}
// ******************************************************************************************
// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Text >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
-size: Font size;
*/
void ES_TFT::drawChar(int32_t x, int32_t y, uint16_t c, uint32_t color, uint32_t bg, uint8_t size){
...
-size: Font size;
*/
int16_t ES_TFT::drawNumber(long intNumber, int32_t x, int32_t y, uint8_t font){
...
-y: Initial Y coordinate;
*/
int16_t ES_TFT::drawNumber(long intNumber, int32_t x, int32_t y){
...
-size: Font size;
*/
int16_t ES_TFT::drawFloat(float floatNumber, uint8_t decimal, int32_t x, int32_t y, uint8_t font){
...
-y: Initial Y coordinate;
*/
int16_t ES_TFT::drawFloat(float floatNumber, uint8_t decimal, int32_t x, int32_t y){
...
-size: Font size;
*/
int16_t ES_TFT::drawString(const char *string, int32_t x, int32_t y, uint8_t font){
...
-y: Initial Y coordinate;
*/
int16_t ES_TFT::drawString(const char *string, int32_t x, int32_t y){
...
-size: Font size;
*/
int16_t ES_TFT::drawString(const String& string, int32_t x, int32_t y, uint8_t font){
    return tft.drawString(string, x, y, font);
}
...
-y: Initial Y coordinate;
*/
int16_t ES_TFT::drawString(const String& string, int32_t x, int32_t y){
    return tft.drawString(string, x, y);
}
...
- font: Font Size
*/
int16_t ES_TFT::drawCentreString(const char *string, int32_t x, int32_t y, uint8_t font){
...
- font: Font Size
*/
int16_t ES_TFT::drawCentreString(const String& string, int32_t x, int32_t y, uint8_t font){
    return tft.drawCentreString(string, x, y, font);
}
...
- font: Font Size
*/
int16_t ES_TFT::drawRightString(const char *string, int32_t x, int32_t y, uint8_t font){
...
- font: Font Size
*/
int16_t ES_TFT::drawRightString(const String& string, int32_t x, int32_t y, uint8_t font){
    return tft.drawRightString(string, x, y, font);
}
...
/* <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Cor do texto >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> */
// Cor do texto
void ES_TFT::setTextColor(uint16_t fgcolor){  
    tft.setTextColor(fgcolor);
}
void ES_TFT::setTextColor(uint16_t fgcolor, uint16_t bgcolor){  
    tft.setTextColor(fgcolor, bgcolor);
}
/* <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Exibe o texto no display >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> */
// Exibe o texto no display
size_t ES_TFT::print(String label){  
    return tft.print(label);
}
size_t ES_TFT::print(int16_t x, int16_t y, uint32_t color, String label, uint32_t bgcolor){ 
    tft.setCursor(x, y);
//    tft.setTextColor(color, bgcolor);
    tft.setTextColor(color);
    return tft.print(label);
}
size_t ES_TFT::print(int16_t x, int16_t y, String label){ 
    tft.setCursor(x, y);
    return tft.print(label);
}
size_t ES_TFT::print(uint32_t color, String label, uint32_t bgcolor){ 
//    tft.setTextColor(color, bgcolor);
    tft.setTextColor(color);
    return tft.print(label);
}
...
// Exibe o texto no display com quebra de linha
size_t ES_TFT::println(String label){  
    return tft.println(label);
}
size_t ES_TFT::println(uint32_t color, String label, uint32_t bgcolor){ 
//    tft.setTextColor(color, bgcolor);
    tft.setTextColor(color);
    return tft.println(label);
}
...
// Retorna o nome do ultimo arquivo JPEG aberto
String ES_TFT::getFileNameRenderJPEG(void){
...
//boolean ES_TFT::renderJPEG(String fileName, boolean sdCard, int xpos, int ypos) {
boolean ES_TFT::renderJPEG(fs::FS& fs, const String& fileName, int xpos, int ypos) {    
...
// - xpos: Referencia X no plano cartesiano do display
// - ypos: Referencia Y no plano cartesiano do display
boolean ES_TFT::renderFirstFileJPEG(fs::FS& fs, const String& directory, int xpos, int ypos){
...
// - xpos: Referencia X no plano cartesiano do display
// - ypos: Referencia Y no plano cartesiano do display
boolean ES_TFT::renderLastFileJPEG(fs::FS& fs, const String& directory, int xpos, int ypos){
...
//boolean ES_TFT::renderNextFileJPEG(int xpos, int ypos){
boolean ES_TFT::renderNextFileJPEG(fs::FS& fs, const String& directory, int xpos, int ypos){
...
//   - renderFirstFileJPEG(String directory, boolean sdCard, int xpos, int ypos)
//   - renderLastFileJPEG(String directory, boolean sdCard, int xpos = 0, int ypos = 0 )
boolean ES_TFT::renderPreviousFileJPEG(fs::FS& fs, const String& directory, int xpos, int ypos){
